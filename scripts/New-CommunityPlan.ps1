...
try {
    Write-Host 'Signing in to the Maker Portal...'
    ...
    Write-Host 'Checking if Community Plan environment has been provisioned...'
    $time = 0
    $interval = 5000
    $timeout = 120000
    do {
    ...
    Write-Host 'Community Plan environment has been provisioned'
}
finally {
    Write-Host 'Quitting IE...'
    $ie.Quit()
}
