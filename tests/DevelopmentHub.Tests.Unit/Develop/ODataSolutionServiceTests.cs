namespace DevelopmentHub.Tests.Unit.Develop
{
    ...
    using Moq;
    using Xunit;
    using Solution = DevelopmentHub.Develop.Model.OData.Solution;
    ...
    public class ODataSolutionServiceTests
    {
        ...
        {
            await Assert.ThrowsAsync<ArgumentNullException>(() => this.oDataSolutionService.MergeSolutionComponentsAsync(null, "devhub_Target", true))
        ...
        {
            await Assert.ThrowsAsync<ArgumentNullException>(() => this.oDataSolutionService.MergeSolutionComponentsAsync("devhub_Source", null, true))
                .ConfigureAwait(false);
        }
        ...
        {
            var sourceSolutionName = "devhub_Source";
            ...
            var targetSolutionName = "devhub_Target";
            ...
            await this.oDataSolutionService.MergeSolutionComponentsAsync("devhub_Source", "devhub_Target", true).ConfigureAwait(false);
        ...
        public async Task MergeSolutionComponents_DeleteSourceSolutionAfterMergeFalse_DoesNotDeleteSourceSolution()
        {
            ...
            await this.oDataSolutionService.MergeSolutionComponentsAsync("devhub_Source", "devhub_Target", false).ConfigureAwait(false);
