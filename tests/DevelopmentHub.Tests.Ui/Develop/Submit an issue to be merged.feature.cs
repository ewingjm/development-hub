...
#line hidden
        ...
        public SubmitAnIssueToBeMergedFeature(SubmitAnIssueToBeMergedFeature.FixtureData fixtureData, DevelopmentHub_Tests_Ui_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
#line 30
 testRunner.And("I enter true in the devhub_manualmergeactivities two options field", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 31
 testRunner.Then("I can see the following fields", ((string)(null)), table7, "Then ");
#line hidden
                ...
                table8.AddRow(new string[] {
                            "devhub_manualmergeactivitiescomplete"});
#line 34
 testRunner.And("I can\'t edit the following fields", ((string)(null)), table8, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        
        [Xunit.SkippableFactAttribute(DisplayName="Update manual merge activities when solution merge status is awaiting manual merg" +
            "e")]
        [Xunit.TraitAttribute("FeatureTitle", "Submit an issue to be merged")]
        [Xunit.TraitAttribute("Description", "Update manual merge activities when solution merge status is awaiting manual merg" +
            "e")]
        public virtual void UpdateManualMergeActivitiesWhenSolutionMergeStatusIsAwaitingManualMerge()
        {
            string[] tagsOfScenario = ((string[])(null));
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Update manual merge activities when solution merge status is awaiting manual merg" +
                    "e", null, ((string[])(null)));
#line 38
this.ScenarioInitialize(scenarioInfo);
#line hidden
...
#line hidden
#line 40
 testRunner.And("I have created an \'Awaiting Manual Merge\' solution merge", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 41
...
#line hidden
                ...
                table9.AddRow(new string[] {
                            "devhub_manualmergeactivitiescomplete"});
#line 42
 testRunner.Then("I can edit the following fields", ((string)(null)), table9, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
